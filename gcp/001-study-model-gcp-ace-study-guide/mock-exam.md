...
A timed practice run. Aim for **2 hours** end-to-end (the same as the real exam) and **≥80%** correct before booking the real thing.

**How to take it:**
1. Go straight through, mark the ones you're unsure about, don't peek.
2. Cover the answer key (everything below the horizontal rule after Q50) until you're done.
3. Review *every* answer afterward, especially the ones you got right by guessing.

The questions span the four exam domains roughly in proportion: ~12 from Section 1, ~15 from Section 2, ~13 from Section 3, ~10 from Section 4.
...
Each answer includes the correct option and the lesson where the topic is covered for review.
...
| 4 | **B** | Budgets only alert; hard cap pattern is Pub/Sub → Cloud Function disables billing. (1.2) |
...
| 43 | **D** | Custom role for surgical permissions when no predefined fits. (4.1) |
...
| 35–39 (70–78%) | On the edge. Re-read the lessons in your weakest domain (most wrong answers concentrated where) and retake this in 2–3 days. |
| <35 (<70%) | Not ready. Targeted re-reading of weak domains; redo the *Practice scenarios* in each weak lesson; come back to this in a week. |

A note on the real exam: Google's questions are usually a touch trickier than these — more distractors that look plausible. Aim for ≥85% here to give yourself a safe margin.
